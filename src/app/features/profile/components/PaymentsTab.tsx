  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-text-muted mt-0.5">Historial de tus compras realizadas</p>
      </div>

      {/* Payments list */}
      <div className="rounded-xl border border-border">
        <div className="px-5 py-3 border-b border-border">
          <h3 className="font-heading font-bold text-black text-sm">Historial de compras</h3>
        </div>
          ...
          {payments.map((payment, i) => (
            <div key={`${payment.id}-${i}`} className="flex items-center gap-4 px-5 py-4">
              ...
              <div className="flex-1 min-w-0">
                <h4 className="font-heading font-bold text-black text-sm">{payment.name}</h4>
              ...
              <div className="text-right shrink-0">
                ...
                <p className="text-xs text-text-muted mt-0.5">{payment.date}</p>
              </div>
