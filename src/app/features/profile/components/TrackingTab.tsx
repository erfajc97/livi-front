  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 mt-0.5">Rastrea tu pedido en tiempo real</p>
      </div>
      ...
      <div className="flex items-center gap-4 rounded-xl border border-gray-200 p-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-gray-500 mt-0.5">Código: {order.id}</p>
      ...
      <div className="rounded-xl border border-gray-200 p-4">
        <div className="flex items-center justify-between text-sm mb-2">
          ...
          <span className="text-gray-500">Entrega estimada: {order.estimatedDate}</span>
        </div>
          ...
          {steps.map((step, i) => {
            ...
            return (
              <div key={step.title} className="relative flex gap-4 pb-6 last:pb-0">
                ...
                {/* Content */}
                <div className="flex-1 min-w-0">
                  <p className={`text-sm font-semibold ${step.active ? 'text-accent' : step.completed ? 'text-black' : 'text-gray-500'}`}>
                    {step.title}
                  </p>
      ...
      <div className="flex gap-3">
        ...
        <button className="flex-1 rounded-lg border border-gray-200 py-3 text-sm font-semibold text-black transition-colors hover:bg-gray-200">
