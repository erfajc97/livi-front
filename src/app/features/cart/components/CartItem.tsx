  ...
  return (
    <div className="flex gap-4 py-5">
      ...
      <div className="flex-1 min-w-0">
        ...
        {/* Variant tag */}
        <span className="inline-block mt-1.5 px-2.5 py-1 text-xs font-bold text-black border border-gray-200 rounded">
          {variantLabel}
        </span>
        ...
        <div className="flex items-center justify-between mt-2">
          {isCombo ? (
            ...
            <div className="flex items-center gap-0">
              ...
              <span className="w-8 h-7 flex items-center justify-center border-y border-gray-200 text-xs font-bold text-black select-none">
                {item.quantity}
              </span>
              <button
                onClick={() => onQtyChange(item.variantId, item.quantity + 1)}
