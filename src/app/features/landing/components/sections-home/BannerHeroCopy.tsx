...
export default function BannerHeroCopy({
  ...
  return (
    <div className="max-w-[38rem]">
      ...
      >
        Pañaleras de cuero para padres modernos
      </TitleTag>
      <p
      ...
      >
        Piezas de cuero genuino, hechas a mano en Ecuador{' '}
        <strong className={`font-semibold ${onDark ? 'text-bg' : 'text-text'}`}>
          desde $119
        </strong>{' '}
        — diseñadas para llevar más, sin parecer una pañalera.
      </p>
