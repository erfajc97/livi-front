import { useBajoPedidoCategoriesQuery } from '@/app/tanstack-queries/categoriesQuery';
      ...
      >
        ...
        <div className="px-10 pt-7 pb-4">
          <h3 className="font-heading text-xl font-bold tracking-widest uppercase text-white text-center">
            BAJO <span className="text-accent">PEDIDO</span>
          </h3>
        </div>
        ...
        <div className="flex flex-col pb-6 px-4">
          {categories.length === 0 ? (
            <p className="text-center text-base text-white/50 py-4">No hay categorías bajo pedido</p>
          ) : (
            <>
              {/* "All" bajo pedido — always first, clickable link */}
