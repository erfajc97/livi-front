...
const STATIC_DELIVERY_OPTIONS: DeliveryOption[] = [
  ...
  { id: 'servientrega-gye', method: 'SERVIENTREGA_GYE', label: 'Envío Servientrega (Guayaquil - Durán - Samborondón)', cost: 3, cities: GYE_CITIES },
  { id: 'servientrega-nacional', method: 'SERVIENTREGA_NACIONAL', label: 'Envío Provincias', cost: 7, cities: [] },
];
